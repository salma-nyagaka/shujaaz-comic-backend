...
DJANGO_SETTINGS_MODULE=shujaaz.settings SECRET_KEY="mi+xv3xefdu@3bt_&lxhhys-9b#(vkhu*_iot-+5&5h2p%+in9" PSQL_DB_NAME=postgres PSQL_DB_USER=www-data PSQL_DB_PASSWD='shujaaz' PSQL_HOST=localhost PSQL_PORT=5432 DATABASE_URL=postgres://postgres:'shujaaz'@localhost:5432/postgres ./manage.py makemigrations
DJANGO_SETTINGS_MODULE=shujaaz.settings SECRET_KEY="mi+xv3xefdu@3bt_&lxhhys-9b#(vkhu*_iot-+5&5h2p%+in9" PSQL_DB_NAME=postgres PSQL_DB_USER=www-data P PSQL_DB_PASSWD='shujaaz' PSQL_HOST=localhost PSQL_PORT=5432 DATABASE_URL=postgres://postgres:'shujaaz'@localhost:5432/postgres ./manage.py migrate
